...
ingested: 2026-08-12
sha256: 2b0fdcfb93072b2b5fcdea988358552417e074463eed3cdf183184b4d53b225e
verified_github_api: 20057 stars / 1810 forks / pushed 2026-08-11 / default_branch=feat/server_team
---
...
# GitHub 官方 description (API 验证 2026-08-12)

> TencentDB Agent Memory is a team-level memory hub for AI Agents — turning conversations, docs, and code into four reusable memory assets (Chat Memory, Skill, LLM-Wiki, Code-Graph) that are governed, shared, and equipped across agents and frameworks.

# 本 wiki 的诚实记录 (2026-08-12)

GitHub description 与 README 实际架构**不一致**：
- description 描述「4 reusable memory assets: Chat Memory / Skill / LLM-Wiki / Code-Graph」（按输出物分类）
- README 描述「L0 Conversation → L1 Atom → L2 Scenario → L3 Persona」4 层金字塔（按架构层分类）
- 两者维度不同，可能是不同时期的描述混用
- 本 wiki 实体页同时记录两个描述，由读者自己判断

Topics (GitHub repo metadata): agent, ai-agent, embedding, llm, local-first, long-term-memory, memory, openclaw-plugin, vector-search

# 验证记录

- 之前 wiki 页面 owner 写作 "Tencent/TencentDB-Agent-Memory" — **错误**
- 实际 owner: **TencentCloud** (org)
- URL: https://github.com/TencentCloud/TencentDB-Agent-Memory
- API 验证 stars=20057, language=TypeScript, license=NOASSERTION
- 2026-08-11 仍在 push
