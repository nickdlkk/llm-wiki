...
| **claude-context** | 11.5k | TypeScript | MIT | 向量语义搜索 + Milvus |
| **semble** | 3.6k | Python | MIT | 嵌入向量搜索 |
| **cocoindex** | 1.7k | Python | Apache-2.0 | AST 语义搜索 + Skill |

## 能力矩阵

| 维度 | CodeGraph | GitNexus | semblent | cocoindex | claude-context |
|------|-----------|----------|---------|-----------|----------------|
| **工具调用优化** | 84-96% ↓ | 显著 | ~98% token ↓ | 70% ↓ | 显著 |
| **解析方式** | 多语言 AST | Tree-sitter | 嵌入向量 | Tree-sitter AST | OpenAI Embedding |
| **索引存储** | SQLite | LadybugDB | 向量 | 本地文件 | Zilliz/Milvus |
...
| **无需 API Key** | ✅ | ✅ | ✅ | ✅（full版）| ❌ |
| **PR Review** | ❌ | ✅（企业版） | ❌ | ❌ | ❌ |
| **安装便捷性** | npx 交互 | npm 全家桶 | pip | pipx 1分钟 | npm + Zilliz 注册 |
...
**代表**：semblé、claude-context、cocoindex
