...
- Files created:
  - summaries/harness-engineering/gaode-autonomous-growth-20260531.md
...
- Files created:
  ...
  - summaries/harness-engineering/lencx-agent-dev-guide-20260806.md
  - concepts/agent-native-stack.md (新概念页：11 节 Agent 框架)
  - concepts/pet-attention-mechanism.md (新概念页：注意力协议 + 状态机投影)
- Files updated:
  - concepts/harness-engineering.md (补充 OpenAI 正式定义 + Anthropic Managed Agents 拆分 + 删减型 Harness)
...
- Files created:
  ...
  - summaries/harness-engineering/meituan-agent-evaluation-20260806.md
...
- Files created:
  ...
  - summaries/harness-engineering/taotian-rd-workflow-20260806.md
- Files updated (本批次):
